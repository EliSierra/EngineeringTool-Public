...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Flexible sizing - use minimum size but allow expansion
        self.MainStack.setMinimumSize(QSize(600, 400))
        sizePolicy_stack = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        self.MainStack.setSizePolicy(sizePolicy_stack)
        self.page = QWidget()
        ...
        self.Notes.setFrameShape(QFrame.Shape.Panel)
        ...
        self.Metadata.setFrameShape(QFrame.Shape.NoFrame)
