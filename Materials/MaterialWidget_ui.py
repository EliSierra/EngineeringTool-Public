...
class Ui_Materials(object):
    def setupUi(self, Materials):
        if not Materials.objectName():
            Materials.setObjectName(u"Materials")
        Materials.resize(750, 550)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Materials.sizePolicy().hasHeightForWidth())
        Materials.setSizePolicy(sizePolicy)
        Materials.setStyleSheet(u"background-color: rgb(161, 162, 164);")
        self.verticalLayout = QVBoxLayout(Materials)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.gridLayout = QGridLayout()
        self.gridLayout.setObjectName(u"gridLayout")
        self.frame_5 = QFrame(Materials)
...
"")
        ...
        self.Results.setStyleSheet(u"color: rgb(0, 0, 0);\n"
...
"border-radius: 5px")
        ...
        self.FileSearch = QToolButton(Materials)
        ...
        self.FileSearch.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.FileSearch.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(179, 191, 213);\n"
"border-radius: 5px")
        ...
        self.MaterialAdd = QPushButton(Materials)
        ...
        self.MaterialAdd.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.MaterialAdd.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(179, 191, 213);\n"
"border-radius: 5px")
        ...
        self.SearchBar = QLineEdit(Materials)
        ...
        self.SearchBar.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(229, 230, 232);\n"
"border-radius: 5px")
        ...
        self.Search = QPushButton(Materials)
        ...
        self.Search.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(179, 191, 213);\n"
"border-radius: 5px")
        ...
        self.FileBar = QLineEdit(Materials)
        ...
        self.FileBar.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(229, 230, 232);\n"
"border-radius: 5px")
        self.FileBar.setReadOnly(True)

        self.gridLayout.addWidget(self.FileBar, 8, 2, 1, 5)
    ...
    def retranslateUi(self, Materials):
        Materials.setWindowTitle(QCoreApplication.translate("Materials", u"Form", None))
        self.label.setText(QCoreApplication.translate("Materials", u"Material Search", None))
        self.Results.setText("")
        self.label_3.setText(QCoreApplication.translate("Materials", u"Upload Materials", None))
        self.FileSearch.setText(QCoreApplication.translate("Materials", u"...", None))
        self.label_9.setText(QCoreApplication.translate("Materials", u"Material Database", None))
        self.label_2.setText(QCoreApplication.translate("Materials", u"Material Properties", None))
        self.MaterialAdd.setText(QCoreApplication.translate("Materials", u"Add Material", None))
        self.Search.setText(QCoreApplication.translate("Materials", u"Search", None))
    # retranslateUi
